...
journey
    ...
    section Upptäcker spelet
      ...
      Läser reglerna: 4: Spelare
    section Spelar första matchen
      Spelar första omgången: 5: Spelare
      Förlorar första omgången: 2: Spelare
    section Övar och lär sig
      Spelar mot en vän: 4: Spelare
      Vinner första matchen: 5: Spelare
    section Blir en van spelare
      Blir skickligare: 5: Spelare
      Känner sig nöjd: 4: Spelare
```
